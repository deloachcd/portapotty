...
;; LSP layer - configuration for emacs to act as an IDE with LSP mode
(require 'lsp-layer)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-mode command-log-mode tao-theme counsel evil-collection magit company org-bullets org-roam projectile general minimap ivy dashboard doom-modeline use-package evil)))
(custom-set-faces
