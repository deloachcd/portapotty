...
(custom-set-variables
 ...
 '(package-selected-packages
   '(command-log-mode tao-theme counsel evil-collection magit company org-bullets org-roam projectile general minimap ivy dashboard doom-modeline use-package evil)))
(custom-set-faces
